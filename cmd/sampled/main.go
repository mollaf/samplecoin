...
func main() {
	...
	server.AddCommands(ctx, cdc, rootCmd, sampleApp, exportAppStateAndTMValidators)
...
func sampleApp(logger log.Logger, db dbm.DB, traceStore io.Writer) abci.Application {
